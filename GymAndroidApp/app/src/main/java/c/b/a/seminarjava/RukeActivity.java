...
public class RukeActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		new JSONTask().execute("https://raw.githubusercontent.com/Perhpethua/json/master/handsJson");
	}
...
//----------------------------------KREIRANJE OBJEKATA I NIZOVA------------------------------------------------------------
				...
				// UNUTAR JE niz
				JSONArray parentArray = parentObject.getJSONArray("ruke");
...
//--------------------------dohvacanje teksta iz buffera->konverzija------------------------------------------------
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.menu_ruke, menu);
		return true;
	}
